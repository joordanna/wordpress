		...
		<div class="asaas-supported-coupon-types">
			...
			<p>
				...
				<strong>
					...
					echo esc_html( sprintf( __( 'Asaas gateway currently supports the following coupon types: %s.', 'woo-asaas' ), $subscriptions_helper->get_supported_coupon_types_string() ) );
					?>
				</strong>
			</p>
		</div>
